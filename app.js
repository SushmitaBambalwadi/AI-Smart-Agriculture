...
// This stores either a selected image
// or an image captured from the webcam.
...
analyzeButton.addEventListener(
    ...
    async function () {
        ...
        try {
            ...
            // SHOW MAIN RESULT
            // =================================================
// Keep the selected leaf image visible after analysis
...
startCameraButton.addEventListener(
    ...
    async function () {
        ...
        try {
            ...
            loadingMessage.textContent =
                "Camera started. Show the tomato leaf clearly.";
    ...
    function () {
        ...
        captureCanvas.toBlob(
            function (blob) {
                ...
                loadingMessage.textContent =
                    "Leaf captured successfully. Click Analyze Leaf.";
